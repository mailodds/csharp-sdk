...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class CreateStorefrontDomainRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStorefrontDomainRequest" /> class.
        /// </summary>
        /// <param name="fqdn">Fully qualified domain name</param>
        /// <param name="storeId">Store connection ID</param>
        [JsonConstructor]
        public CreateStorefrontDomainRequest(string fqdn, string storeId)
        {
            Fqdn = fqdn;
            StoreId = storeId;
            OnCreated();
        ...
        /* <example>shop.merchant.com</example> */
        ...
        /// Store connection ID
        /// </summary>
        /// <value>Store connection ID</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateStorefrontDomainRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateStorefrontDomainRequest" />
    /// </summary>
    public class CreateStorefrontDomainRequestJsonConverter : JsonConverter<CreateStorefrontDomainRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateStorefrontDomainRequest" />
        /// </summary>
        ...
        public override CreateStorefrontDomainRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!fqdn.IsSet)
                throw new ArgumentException("Property is required for class CreateStorefrontDomainRequest.", nameof(fqdn));

            if (!storeId.IsSet)
                throw new ArgumentException("Property is required for class CreateStorefrontDomainRequest.", nameof(storeId));

            if (fqdn.IsSet && fqdn.Value == null)
                throw new ArgumentNullException(nameof(fqdn), "Property is not nullable for class CreateStorefrontDomainRequest.");

            if (storeId.IsSet && storeId.Value == null)
                throw new ArgumentNullException(nameof(storeId), "Property is not nullable for class CreateStorefrontDomainRequest.");

            return new CreateStorefrontDomainRequest(fqdn.Value!, storeId.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="CreateStorefrontDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createStorefrontDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateStorefrontDomainRequest createStorefrontDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createStorefrontDomainRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateStorefrontDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createStorefrontDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateStorefrontDomainRequest createStorefrontDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createStorefrontDomainRequest.Fqdn == null)
                throw new ArgumentNullException(nameof(createStorefrontDomainRequest.Fqdn), "Property is required for class CreateStorefrontDomainRequest.");

            if (createStorefrontDomainRequest.StoreId == null)
                throw new ArgumentNullException(nameof(createStorefrontDomainRequest.StoreId), "Property is required for class CreateStorefrontDomainRequest.");

            writer.WriteString("fqdn", createStorefrontDomainRequest.Fqdn);

            writer.WriteString("store_id", createStorefrontDomainRequest.StoreId);
        }
    }
}
