...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class CreateWebhookCliSessionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWebhookCliSessionRequest" /> class.
        /// </summary>
        /// <param name="forwardUrl">Local URL where webhooks will be forwarded</param>
        [JsonConstructor]
        public CreateWebhookCliSessionRequest(Option<string?> forwardUrl = default)
        {
            ForwardUrlOption = forwardUrl;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of ForwardUrl
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> ForwardUrlOption { get; private set; }

        /// <summary>
        /// Local URL where webhooks will be forwarded
        /// </summary>
        /// <value>Local URL where webhooks will be forwarded</value>
        [JsonPropertyName("forward_url")]
        public string? ForwardUrl { get { return this.ForwardUrlOption; } set { this.ForwardUrlOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateWebhookCliSessionRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateWebhookCliSessionRequest" />
    /// </summary>
    public class CreateWebhookCliSessionRequestJsonConverter : JsonConverter<CreateWebhookCliSessionRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateWebhookCliSessionRequest" />
        /// </summary>
        ...
        public override CreateWebhookCliSessionRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> forwardUrl = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "forward_url":
                            forwardUrl = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        default:
                            break;
                    }
            ...
            if (forwardUrl.IsSet && forwardUrl.Value == null)
                throw new ArgumentNullException(nameof(forwardUrl), "Property is not nullable for class CreateWebhookCliSessionRequest.");

            return new CreateWebhookCliSessionRequest(forwardUrl);
        }

        /// <summary>
        /// Serializes a <see cref="CreateWebhookCliSessionRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createWebhookCliSessionRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateWebhookCliSessionRequest createWebhookCliSessionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createWebhookCliSessionRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateWebhookCliSessionRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createWebhookCliSessionRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateWebhookCliSessionRequest createWebhookCliSessionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createWebhookCliSessionRequest.ForwardUrlOption.IsSet && createWebhookCliSessionRequest.ForwardUrl == null)
                throw new ArgumentNullException(nameof(createWebhookCliSessionRequest.ForwardUrl), "Property is required for class CreateWebhookCliSessionRequest.");

            if (createWebhookCliSessionRequest.ForwardUrlOption.IsSet)
                writer.WriteString("forward_url", createWebhookCliSessionRequest.ForwardUrl);
        }
    }
}
