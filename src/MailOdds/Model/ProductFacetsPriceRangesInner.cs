...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class ProductFacetsPriceRangesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductFacetsPriceRangesInner" /> class.
        /// </summary>
        /// <param name="range">Price range label (e.g., &#39;0-10&#39;, &#39;500+&#39;)</param>
        /// <param name="count">count</param>
        [JsonConstructor]
        public ProductFacetsPriceRangesInner(Option<string?> range = default, Option<int?> count = default)
        {
            RangeOption = range;
            CountOption = count;
            OnCreated();
        ...
        /// </summary>
        /// <value>Price range label (e.g., &#39;0-10&#39;, &#39;500+&#39;)</value>
        [JsonPropertyName("range")]
        public string? Range { get { return this.RangeOption; } set { this.RangeOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductFacetsPriceRangesInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProductFacetsPriceRangesInner" />
    /// </summary>
    public class ProductFacetsPriceRangesInnerJsonConverter : JsonConverter<ProductFacetsPriceRangesInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProductFacetsPriceRangesInner" />
        /// </summary>
        ...
        public override ProductFacetsPriceRangesInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (range.IsSet && range.Value == null)
                throw new ArgumentNullException(nameof(range), "Property is not nullable for class ProductFacetsPriceRangesInner.");

            if (count.IsSet && count.Value == null)
                throw new ArgumentNullException(nameof(count), "Property is not nullable for class ProductFacetsPriceRangesInner.");

            return new ProductFacetsPriceRangesInner(range, count);
        }

        /// <summary>
        /// Serializes a <see cref="ProductFacetsPriceRangesInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="productFacetsPriceRangesInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProductFacetsPriceRangesInner productFacetsPriceRangesInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, productFacetsPriceRangesInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProductFacetsPriceRangesInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="productFacetsPriceRangesInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProductFacetsPriceRangesInner productFacetsPriceRangesInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (productFacetsPriceRangesInner.RangeOption.IsSet && productFacetsPriceRangesInner.Range == null)
                throw new ArgumentNullException(nameof(productFacetsPriceRangesInner.Range), "Property is required for class ProductFacetsPriceRangesInner.");

            if (productFacetsPriceRangesInner.RangeOption.IsSet)
                writer.WriteString("range", productFacetsPriceRangesInner.Range);

            if (productFacetsPriceRangesInner.CountOption.IsSet)
                writer.WriteNumber("count", productFacetsPriceRangesInner.CountOption.Value!.Value);
        }
    }
}
