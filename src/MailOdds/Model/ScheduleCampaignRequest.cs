...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class ScheduleCampaignRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleCampaignRequest" /> class.
        /// </summary>
        /// <param name="sendAt">Scheduled send time (ISO 8601, must be in the future)</param>
        [JsonConstructor]
        public ScheduleCampaignRequest(DateTime sendAt)
        {
            SendAt = sendAt;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>Scheduled send time (ISO 8601, must be in the future)</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="ScheduleCampaignRequest" />
    /// </summary>
    public class ScheduleCampaignRequestJsonConverter : JsonConverter<ScheduleCampaignRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ScheduleCampaignRequest" />
        /// </summary>
        ...
        public override ScheduleCampaignRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!sendAt.IsSet)
                throw new ArgumentException("Property is required for class ScheduleCampaignRequest.", nameof(sendAt));

            if (sendAt.IsSet && sendAt.Value == null)
                throw new ArgumentNullException(nameof(sendAt), "Property is not nullable for class ScheduleCampaignRequest.");

            return new ScheduleCampaignRequest(sendAt.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="ScheduleCampaignRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="scheduleCampaignRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ScheduleCampaignRequest scheduleCampaignRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, scheduleCampaignRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ScheduleCampaignRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="scheduleCampaignRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ScheduleCampaignRequest scheduleCampaignRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("send_at", scheduleCampaignRequest.SendAt.ToString(SendAtFormat));
        }
    }
}
