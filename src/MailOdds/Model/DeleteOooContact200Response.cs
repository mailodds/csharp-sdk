...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class DeleteOooContact200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteOooContact200Response" /> class.
        /// </summary>
        /// <param name="cleared">cleared</param>
        [JsonConstructor]
        public DeleteOooContact200Response(Option<bool?> cleared = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteOooContact200Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeleteOooContact200Response" />
    /// </summary>
    public class DeleteOooContact200ResponseJsonConverter : JsonConverter<DeleteOooContact200Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="DeleteOooContact200Response" />
        /// </summary>
        ...
        public override DeleteOooContact200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cleared.IsSet && cleared.Value == null)
                throw new ArgumentNullException(nameof(cleared), "Property is not nullable for class DeleteOooContact200Response.");

            return new DeleteOooContact200Response(cleared);
        }

        /// <summary>
        /// Serializes a <see cref="DeleteOooContact200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteOooContact200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeleteOooContact200Response deleteOooContact200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, deleteOooContact200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeleteOooContact200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteOooContact200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeleteOooContact200Response deleteOooContact200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (deleteOooContact200Response.ClearedOption.IsSet)
                writer.WriteBoolean("cleared", deleteOooContact200Response.ClearedOption.Value!.Value);
        }
    }
}
