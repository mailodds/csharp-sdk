...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class AddContact201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddContact201Response" /> class.
        /// </summary>
        /// <param name="schemaVersion">schemaVersion</param>
        /// <param name="requestId">requestId</param>
        /// <param name="contact">contact</param>
        [JsonConstructor]
        public AddContact201Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<Object?> contact = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Object?> ContactOption { get; private set; }

        /// <summary>
        /// Gets or Sets Contact
        /// </summary>
        [JsonPropertyName("contact")]
        public Object? Contact { get { return this.ContactOption; } set { this.ContactOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddContact201Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="AddContact201Response" />
    /// </summary>
    public class AddContact201ResponseJsonConverter : JsonConverter<AddContact201Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="AddContact201Response" />
        /// </summary>
        ...
        public override AddContact201Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "request_id":
                            ...
                            break;
                        case "contact":
                            contact = new Option<Object?>(JsonSerializer.Deserialize<Object>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class AddContact201Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class AddContact201Response.");

            if (contact.IsSet && contact.Value == null)
                throw new ArgumentNullException(nameof(contact), "Property is not nullable for class AddContact201Response.");

            return new AddContact201Response(schemaVersion, requestId, contact);
        }

        /// <summary>
        /// Serializes a <see cref="AddContact201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addContact201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AddContact201Response addContact201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, addContact201Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AddContact201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addContact201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AddContact201Response addContact201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (addContact201Response.SchemaVersionOption.IsSet && addContact201Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(addContact201Response.SchemaVersion), "Property is required for class AddContact201Response.");

            if (addContact201Response.RequestIdOption.IsSet && addContact201Response.RequestId == null)
                throw new ArgumentNullException(nameof(addContact201Response.RequestId), "Property is required for class AddContact201Response.");

            if (addContact201Response.ContactOption.IsSet && addContact201Response.Contact == null)
                throw new ArgumentNullException(nameof(addContact201Response.Contact), "Property is required for class AddContact201Response.");

            if (addContact201Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", addContact201Response.SchemaVersion);

            if (addContact201Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", addContact201Response.RequestId);

            if (addContact201Response.ContactOption.IsSet)
            {
                writer.WritePropertyName("contact");
                JsonSerializer.Serialize(writer, addContact201Response.Contact, jsonSerializerOptions);
            }
        }
    }
}
