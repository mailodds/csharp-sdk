...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class BatchDeliverRequestStructuredData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchDeliverRequestStructuredData" /> class.
        /// </summary>
        /// <param name="object"></param>
        internal BatchDeliverRequestStructuredData(Object @object)
        {
            Object = @object;
            OnCreated();
        }
        ...
        internal BatchDeliverRequestStructuredData(List<Object> list)
        {
            List = list;
            OnCreated();
        }
        ...
        internal BatchDeliverRequestStructuredData(string @string)
        {
            String = @string;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchDeliverRequestStructuredData {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="BatchDeliverRequestStructuredData" />
    /// </summary>
    public class BatchDeliverRequestStructuredDataJsonConverter : JsonConverter<BatchDeliverRequestStructuredData>
    {
        /// <summary>
        /// Deserializes json to <see cref="BatchDeliverRequestStructuredData" />
        /// </summary>
        ...
        public override BatchDeliverRequestStructuredData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (varObject != null)
                return new BatchDeliverRequestStructuredData(varObject);

            if (list != null)
                return new BatchDeliverRequestStructuredData(list);

            if (varString != null)
                return new BatchDeliverRequestStructuredData(varString);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="BatchDeliverRequestStructuredData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="batchDeliverRequestStructuredData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BatchDeliverRequestStructuredData batchDeliverRequestStructuredData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, batchDeliverRequestStructuredData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BatchDeliverRequestStructuredData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="batchDeliverRequestStructuredData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BatchDeliverRequestStructuredData batchDeliverRequestStructuredData, JsonSerializerOptions jsonSerializerOptions)
        {
