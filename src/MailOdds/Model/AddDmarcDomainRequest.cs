...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class AddDmarcDomainRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddDmarcDomainRequest" /> class.
        /// </summary>
        /// <param name="domain">Domain name to monitor</param>
        [JsonConstructor]
        public AddDmarcDomainRequest(string domain)
        {
            Domain = domain;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>Domain name to monitor</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="AddDmarcDomainRequest" />
    /// </summary>
    public class AddDmarcDomainRequestJsonConverter : JsonConverter<AddDmarcDomainRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="AddDmarcDomainRequest" />
        /// </summary>
        ...
        public override AddDmarcDomainRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!domain.IsSet)
                throw new ArgumentException("Property is required for class AddDmarcDomainRequest.", nameof(domain));

            if (domain.IsSet && domain.Value == null)
                throw new ArgumentNullException(nameof(domain), "Property is not nullable for class AddDmarcDomainRequest.");

            return new AddDmarcDomainRequest(domain.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="AddDmarcDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addDmarcDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AddDmarcDomainRequest addDmarcDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, addDmarcDomainRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AddDmarcDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addDmarcDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AddDmarcDomainRequest addDmarcDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (addDmarcDomainRequest.Domain == null)
                throw new ArgumentNullException(nameof(addDmarcDomainRequest.Domain), "Property is required for class AddDmarcDomainRequest.");

            writer.WriteString("domain", addDmarcDomainRequest.Domain);
        }
    }
}
