...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class QueryContactList200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryContactList200Response" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public QueryContactList200Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<List<QueryContactList200ResponseEmailsInner>?> emails = default, Option<int?> total = default, Option<int?> page = default, Option<int?> perPage = default, Option<int?> pages = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<QueryContactList200ResponseEmailsInner>?> EmailsOption { get; private set; }

        /// <summary>
        /// Gets or Sets Emails
        /// </summary>
        [JsonPropertyName("emails")]
        public List<QueryContactList200ResponseEmailsInner>? Emails { get { return this.EmailsOption; } set { this.EmailsOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="QueryContactList200Response" />
    /// </summary>
    public class QueryContactList200ResponseJsonConverter : JsonConverter<QueryContactList200Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="QueryContactList200Response" />
        /// </summary>
        ...
        public override QueryContactList200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<QueryContactList200ResponseEmailsInner>?> emails = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "request_id":
                            ...
                            break;
                        case "emails":
                            emails = new Option<List<QueryContactList200ResponseEmailsInner>?>(JsonSerializer.Deserialize<List<QueryContactList200ResponseEmailsInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "total":
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class QueryContactList200Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class QueryContactList200Response.");

            if (emails.IsSet && emails.Value == null)
                throw new ArgumentNullException(nameof(emails), "Property is not nullable for class QueryContactList200Response.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class QueryContactList200Response.");

            if (page.IsSet && page.Value == null)
                throw new ArgumentNullException(nameof(page), "Property is not nullable for class QueryContactList200Response.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class QueryContactList200Response.");

            if (pages.IsSet && pages.Value == null)
                throw new ArgumentNullException(nameof(pages), "Property is not nullable for class QueryContactList200Response.");

            return new QueryContactList200Response(schemaVersion, requestId, emails, total, page, perPage, pages);
        }

        /// <summary>
        /// Serializes a <see cref="QueryContactList200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="queryContactList200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, QueryContactList200Response queryContactList200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, queryContactList200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="QueryContactList200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="queryContactList200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, QueryContactList200Response queryContactList200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (queryContactList200Response.SchemaVersionOption.IsSet && queryContactList200Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(queryContactList200Response.SchemaVersion), "Property is required for class QueryContactList200Response.");

            if (queryContactList200Response.RequestIdOption.IsSet && queryContactList200Response.RequestId == null)
                throw new ArgumentNullException(nameof(queryContactList200Response.RequestId), "Property is required for class QueryContactList200Response.");

            if (queryContactList200Response.EmailsOption.IsSet && queryContactList200Response.Emails == null)
                throw new ArgumentNullException(nameof(queryContactList200Response.Emails), "Property is required for class QueryContactList200Response.");

            if (queryContactList200Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", queryContactList200Response.SchemaVersion);

            if (queryContactList200Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", queryContactList200Response.RequestId);

            if (queryContactList200Response.EmailsOption.IsSet)
            {
                writer.WritePropertyName("emails");
                JsonSerializer.Serialize(writer, queryContactList200Response.Emails, jsonSerializerOptions);
            }
            if (queryContactList200Response.TotalOption.IsSet)
                writer.WriteNumber("total", queryContactList200Response.TotalOption.Value!.Value);

            if (queryContactList200Response.PageOption.IsSet)
                writer.WriteNumber("page", queryContactList200Response.PageOption.Value!.Value);

            if (queryContactList200Response.PerPageOption.IsSet)
                writer.WriteNumber("per_page", queryContactList200Response.PerPageOption.Value!.Value);

            if (queryContactList200Response.PagesOption.IsSet)
                writer.WriteNumber("pages", queryContactList200Response.PagesOption.Value!.Value);
        }
    }
}
