...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class AddDmarcDomain201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddDmarcDomain201Response" /> class.
        /// </summary>
        /// <param name="schemaVersion">schemaVersion</param>
        /// <param name="requestId">requestId</param>
        /// <param name="domain">domain</param>
        [JsonConstructor]
        public AddDmarcDomain201Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<DmarcDomain?> domain = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DmarcDomain?> DomainOption { get; private set; }

        /// <summary>
        /// Gets or Sets Domain
        /// </summary>
        [JsonPropertyName("domain")]
        public DmarcDomain? Domain { get { return this.DomainOption; } set { this.DomainOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddDmarcDomain201Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="AddDmarcDomain201Response" />
    /// </summary>
    public class AddDmarcDomain201ResponseJsonConverter : JsonConverter<AddDmarcDomain201Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="AddDmarcDomain201Response" />
        /// </summary>
        ...
        public override AddDmarcDomain201Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DmarcDomain?> domain = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "request_id":
                            ...
                            break;
                        case "domain":
                            domain = new Option<DmarcDomain?>(JsonSerializer.Deserialize<DmarcDomain>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class AddDmarcDomain201Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class AddDmarcDomain201Response.");

            if (domain.IsSet && domain.Value == null)
                throw new ArgumentNullException(nameof(domain), "Property is not nullable for class AddDmarcDomain201Response.");

            return new AddDmarcDomain201Response(schemaVersion, requestId, domain);
        }

        /// <summary>
        /// Serializes a <see cref="AddDmarcDomain201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addDmarcDomain201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AddDmarcDomain201Response addDmarcDomain201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, addDmarcDomain201Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AddDmarcDomain201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addDmarcDomain201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AddDmarcDomain201Response addDmarcDomain201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (addDmarcDomain201Response.SchemaVersionOption.IsSet && addDmarcDomain201Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(addDmarcDomain201Response.SchemaVersion), "Property is required for class AddDmarcDomain201Response.");

            if (addDmarcDomain201Response.RequestIdOption.IsSet && addDmarcDomain201Response.RequestId == null)
                throw new ArgumentNullException(nameof(addDmarcDomain201Response.RequestId), "Property is required for class AddDmarcDomain201Response.");

            if (addDmarcDomain201Response.DomainOption.IsSet && addDmarcDomain201Response.Domain == null)
                throw new ArgumentNullException(nameof(addDmarcDomain201Response.Domain), "Property is required for class AddDmarcDomain201Response.");

            if (addDmarcDomain201Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", addDmarcDomain201Response.SchemaVersion);

            if (addDmarcDomain201Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", addDmarcDomain201Response.RequestId);

            if (addDmarcDomain201Response.DomainOption.IsSet)
            {
                writer.WritePropertyName("domain");
                JsonSerializer.Serialize(writer, addDmarcDomain201Response.Domain, jsonSerializerOptions);
            }
        }
    }
}
