...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class UpdateReplyForwardingRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateReplyForwardingRequest" /> class.
        /// </summary>
        /// <param name="forwardRepliesTo">Email to forward replies to, or null to disable</param>
        [JsonConstructor]
        public UpdateReplyForwardingRequest(Option<string?> forwardRepliesTo = default)
        {
        ...
        /// </summary>
        /// <value>Email to forward replies to, or null to disable</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateReplyForwardingRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateReplyForwardingRequest" />
    /// </summary>
    public class UpdateReplyForwardingRequestJsonConverter : JsonConverter<UpdateReplyForwardingRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdateReplyForwardingRequest" />
        /// </summary>
        ...
        public override UpdateReplyForwardingRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new UpdateReplyForwardingRequest(forwardRepliesTo);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateReplyForwardingRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateReplyForwardingRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateReplyForwardingRequest updateReplyForwardingRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateReplyForwardingRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateReplyForwardingRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateReplyForwardingRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateReplyForwardingRequest updateReplyForwardingRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateReplyForwardingRequest.ForwardRepliesToOption.IsSet)
                if (updateReplyForwardingRequest.ForwardRepliesToOption.Value != null)
                    writer.WriteString("forward_replies_to", updateReplyForwardingRequest.ForwardRepliesTo);
                else
