...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class BulkUpdateProducts200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkUpdateProducts200Response" /> class.
        /// </summary>
        /// <param name="schemaVersion">schemaVersion</param>
        /// <param name="requestId">requestId</param>
        /// <param name="updated">updated</param>
        [JsonConstructor]
        public BulkUpdateProducts200Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<int?> updated = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkUpdateProducts200Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="BulkUpdateProducts200Response" />
    /// </summary>
    public class BulkUpdateProducts200ResponseJsonConverter : JsonConverter<BulkUpdateProducts200Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="BulkUpdateProducts200Response" />
        /// </summary>
        ...
        public override BulkUpdateProducts200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class BulkUpdateProducts200Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class BulkUpdateProducts200Response.");

            if (updated.IsSet && updated.Value == null)
                throw new ArgumentNullException(nameof(updated), "Property is not nullable for class BulkUpdateProducts200Response.");

            return new BulkUpdateProducts200Response(schemaVersion, requestId, updated);
        }

        /// <summary>
        /// Serializes a <see cref="BulkUpdateProducts200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bulkUpdateProducts200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BulkUpdateProducts200Response bulkUpdateProducts200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, bulkUpdateProducts200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BulkUpdateProducts200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bulkUpdateProducts200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BulkUpdateProducts200Response bulkUpdateProducts200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (bulkUpdateProducts200Response.SchemaVersionOption.IsSet && bulkUpdateProducts200Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(bulkUpdateProducts200Response.SchemaVersion), "Property is required for class BulkUpdateProducts200Response.");

            if (bulkUpdateProducts200Response.RequestIdOption.IsSet && bulkUpdateProducts200Response.RequestId == null)
                throw new ArgumentNullException(nameof(bulkUpdateProducts200Response.RequestId), "Property is required for class BulkUpdateProducts200Response.");

            if (bulkUpdateProducts200Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", bulkUpdateProducts200Response.SchemaVersion);

            if (bulkUpdateProducts200Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", bulkUpdateProducts200Response.RequestId);

            if (bulkUpdateProducts200Response.UpdatedOption.IsSet)
                writer.WriteNumber("updated", bulkUpdateProducts200Response.UpdatedOption.Value!.Value);
        }
    }
}
