...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class RunServerTestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RunServerTestRequest" /> class.
        /// </summary>
        /// <param name="domain">Domain to test</param>
        [JsonConstructor]
        public RunServerTestRequest(string domain)
        {
            Domain = domain;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RunServerTestRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="RunServerTestRequest" />
    /// </summary>
    public class RunServerTestRequestJsonConverter : JsonConverter<RunServerTestRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="RunServerTestRequest" />
        /// </summary>
        ...
        public override RunServerTestRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!domain.IsSet)
                throw new ArgumentException("Property is required for class RunServerTestRequest.", nameof(domain));

            if (domain.IsSet && domain.Value == null)
                throw new ArgumentNullException(nameof(domain), "Property is not nullable for class RunServerTestRequest.");

            return new RunServerTestRequest(domain.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="RunServerTestRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="runServerTestRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RunServerTestRequest runServerTestRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, runServerTestRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RunServerTestRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="runServerTestRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RunServerTestRequest runServerTestRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (runServerTestRequest.Domain == null)
                throw new ArgumentNullException(nameof(runServerTestRequest.Domain), "Property is required for class RunServerTestRequest.");

            writer.WriteString("domain", runServerTestRequest.Domain);
        }
    }
}
