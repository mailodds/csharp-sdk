...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class DeliverRequestToInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeliverRequestToInner" /> class.
        /// </summary>
        /// <param name="email">email</param>
        /// <param name="name">name</param>
        [JsonConstructor]
        public DeliverRequestToInner(string email, Option<string?> name = default)
        {
            Email = email;
            NameOption = name;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeliverRequestToInner" />
    /// </summary>
    public class DeliverRequestToInnerJsonConverter : JsonConverter<DeliverRequestToInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="DeliverRequestToInner" />
        /// </summary>
        ...
        public override DeliverRequestToInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!email.IsSet)
                throw new ArgumentException("Property is required for class DeliverRequestToInner.", nameof(email));

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class DeliverRequestToInner.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class DeliverRequestToInner.");

            return new DeliverRequestToInner(email.Value!, name);
        }

        /// <summary>
        /// Serializes a <see cref="DeliverRequestToInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deliverRequestToInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeliverRequestToInner deliverRequestToInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, deliverRequestToInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeliverRequestToInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deliverRequestToInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeliverRequestToInner deliverRequestToInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (deliverRequestToInner.Email == null)
                throw new ArgumentNullException(nameof(deliverRequestToInner.Email), "Property is required for class DeliverRequestToInner.");

            if (deliverRequestToInner.NameOption.IsSet && deliverRequestToInner.Name == null)
                throw new ArgumentNullException(nameof(deliverRequestToInner.Name), "Property is required for class DeliverRequestToInner.");

            writer.WriteString("email", deliverRequestToInner.Email);

            if (deliverRequestToInner.NameOption.IsSet)
                writer.WriteString("name", deliverRequestToInner.Name);
        }
    }
}
