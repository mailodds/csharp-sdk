...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class CreateAlertRule201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAlertRule201Response" /> class.
        /// </summary>
        /// <param name="schemaVersion">schemaVersion</param>
        /// <param name="requestId">requestId</param>
        /// <param name="rule">rule</param>
        [JsonConstructor]
        public CreateAlertRule201Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<AlertRule?> rule = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<AlertRule?> RuleOption { get; private set; }

        /// <summary>
        /// Gets or Sets Rule
        /// </summary>
        [JsonPropertyName("rule")]
        public AlertRule? Rule { get { return this.RuleOption; } set { this.RuleOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateAlertRule201Response" />
    /// </summary>
    public class CreateAlertRule201ResponseJsonConverter : JsonConverter<CreateAlertRule201Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateAlertRule201Response" />
        /// </summary>
        ...
        public override CreateAlertRule201Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "request_id":
                            ...
                            break;
                        case "rule":
                            rule = new Option<AlertRule?>(JsonSerializer.Deserialize<AlertRule>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class CreateAlertRule201Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class CreateAlertRule201Response.");

            if (rule.IsSet && rule.Value == null)
                throw new ArgumentNullException(nameof(rule), "Property is not nullable for class CreateAlertRule201Response.");

            return new CreateAlertRule201Response(schemaVersion, requestId, rule);
        }

        /// <summary>
        /// Serializes a <see cref="CreateAlertRule201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createAlertRule201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateAlertRule201Response createAlertRule201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createAlertRule201Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateAlertRule201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createAlertRule201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateAlertRule201Response createAlertRule201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createAlertRule201Response.SchemaVersionOption.IsSet && createAlertRule201Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(createAlertRule201Response.SchemaVersion), "Property is required for class CreateAlertRule201Response.");

            if (createAlertRule201Response.RequestIdOption.IsSet && createAlertRule201Response.RequestId == null)
                throw new ArgumentNullException(nameof(createAlertRule201Response.RequestId), "Property is required for class CreateAlertRule201Response.");

            if (createAlertRule201Response.RuleOption.IsSet && createAlertRule201Response.Rule == null)
                throw new ArgumentNullException(nameof(createAlertRule201Response.Rule), "Property is required for class CreateAlertRule201Response.");

            if (createAlertRule201Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", createAlertRule201Response.SchemaVersion);

            if (createAlertRule201Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", createAlertRule201Response.RequestId);

            if (createAlertRule201Response.RuleOption.IsSet)
            {
                writer.WritePropertyName("rule");
                JsonSerializer.Serialize(writer, createAlertRule201Response.Rule, jsonSerializerOptions);
            }
        }
    }
}
