...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class BulkUpdateProductsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkUpdateProductsRequest" /> class.
        /// </summary>
        /// <param name="productIds">Product IDs to update</param>
        /// <param name="isActive">Set product visibility</param>
        [JsonConstructor]
        public BulkUpdateProductsRequest(List<string> productIds, bool isActive)
        {
        ...
        /// </summary>
        /// <value>Product IDs to update</value>
        ...
        /// </summary>
        /// <value>Set product visibility</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="BulkUpdateProductsRequest" />
    /// </summary>
    public class BulkUpdateProductsRequestJsonConverter : JsonConverter<BulkUpdateProductsRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="BulkUpdateProductsRequest" />
        /// </summary>
        ...
        public override BulkUpdateProductsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<string>?> productIds = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "product_ids":
                            productIds = new Option<List<string>?>(JsonSerializer.Deserialize<List<string>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "is_active":
            ...
            if (!productIds.IsSet)
                throw new ArgumentException("Property is required for class BulkUpdateProductsRequest.", nameof(productIds));

            if (!isActive.IsSet)
                throw new ArgumentException("Property is required for class BulkUpdateProductsRequest.", nameof(isActive));

            if (productIds.IsSet && productIds.Value == null)
                throw new ArgumentNullException(nameof(productIds), "Property is not nullable for class BulkUpdateProductsRequest.");

            if (isActive.IsSet && isActive.Value == null)
                throw new ArgumentNullException(nameof(isActive), "Property is not nullable for class BulkUpdateProductsRequest.");

            return new BulkUpdateProductsRequest(productIds.Value!, isActive.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="BulkUpdateProductsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bulkUpdateProductsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BulkUpdateProductsRequest bulkUpdateProductsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, bulkUpdateProductsRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BulkUpdateProductsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bulkUpdateProductsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BulkUpdateProductsRequest bulkUpdateProductsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (bulkUpdateProductsRequest.ProductIds == null)
                throw new ArgumentNullException(nameof(bulkUpdateProductsRequest.ProductIds), "Property is required for class BulkUpdateProductsRequest.");

            writer.WritePropertyName("product_ids");
            JsonSerializer.Serialize(writer, bulkUpdateProductsRequest.ProductIds, jsonSerializerOptions);
            writer.WriteBoolean("is_active", bulkUpdateProductsRequest.IsActive);
        }
    }
}
