...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class ListStores200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListStores200Response" /> class.
        /// </summary>
        /// <param name="schemaVersion">schemaVersion</param>
        /// <param name="requestId">requestId</param>
        /// <param name="stores">stores</param>
        [JsonConstructor]
        public ListStores200Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<List<StoreConnection>?> stores = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<StoreConnection>?> StoresOption { get; private set; }

        /// <summary>
        /// Gets or Sets Stores
        /// </summary>
        [JsonPropertyName("stores")]
        public List<StoreConnection>? Stores { get { return this.StoresOption; } set { this.StoresOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListStores200Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ListStores200Response" />
    /// </summary>
    public class ListStores200ResponseJsonConverter : JsonConverter<ListStores200Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="ListStores200Response" />
        /// </summary>
        ...
        public override ListStores200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<StoreConnection>?> stores = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "request_id":
                            ...
                            break;
                        case "stores":
                            stores = new Option<List<StoreConnection>?>(JsonSerializer.Deserialize<List<StoreConnection>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class ListStores200Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class ListStores200Response.");

            if (stores.IsSet && stores.Value == null)
                throw new ArgumentNullException(nameof(stores), "Property is not nullable for class ListStores200Response.");

            return new ListStores200Response(schemaVersion, requestId, stores);
        }

        /// <summary>
        /// Serializes a <see cref="ListStores200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listStores200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListStores200Response listStores200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listStores200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListStores200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listStores200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListStores200Response listStores200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listStores200Response.SchemaVersionOption.IsSet && listStores200Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(listStores200Response.SchemaVersion), "Property is required for class ListStores200Response.");

            if (listStores200Response.RequestIdOption.IsSet && listStores200Response.RequestId == null)
                throw new ArgumentNullException(nameof(listStores200Response.RequestId), "Property is required for class ListStores200Response.");

            if (listStores200Response.StoresOption.IsSet && listStores200Response.Stores == null)
                throw new ArgumentNullException(nameof(listStores200Response.Stores), "Property is required for class ListStores200Response.");

            if (listStores200Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", listStores200Response.SchemaVersion);

            if (listStores200Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", listStores200Response.RequestId);

            if (listStores200Response.StoresOption.IsSet)
            {
                writer.WritePropertyName("stores");
                JsonSerializer.Serialize(writer, listStores200Response.Stores, jsonSerializerOptions);
            }
        }
    }
}
