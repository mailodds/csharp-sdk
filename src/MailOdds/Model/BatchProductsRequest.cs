...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class BatchProductsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchProductsRequest" /> class.
        /// </summary>
        /// <param name="products">products</param>
        [JsonConstructor]
        public BatchProductsRequest(List<BatchProductsRequestProductsInner> products)
        {
            Products = products;
            OnCreated();
        }
        ...
        public List<BatchProductsRequestProductsInner> Products { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchProductsRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="BatchProductsRequest" />
    /// </summary>
    public class BatchProductsRequestJsonConverter : JsonConverter<BatchProductsRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="BatchProductsRequest" />
        /// </summary>
        ...
        public override BatchProductsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<BatchProductsRequestProductsInner>?> products = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "products":
                            products = new Option<List<BatchProductsRequestProductsInner>?>(JsonSerializer.Deserialize<List<BatchProductsRequestProductsInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (!products.IsSet)
                throw new ArgumentException("Property is required for class BatchProductsRequest.", nameof(products));

            if (products.IsSet && products.Value == null)
                throw new ArgumentNullException(nameof(products), "Property is not nullable for class BatchProductsRequest.");

            return new BatchProductsRequest(products.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="BatchProductsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="batchProductsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BatchProductsRequest batchProductsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, batchProductsRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BatchProductsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="batchProductsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BatchProductsRequest batchProductsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (batchProductsRequest.Products == null)
                throw new ArgumentNullException(nameof(batchProductsRequest.Products), "Property is required for class BatchProductsRequest.");

            writer.WritePropertyName("products");
            JsonSerializer.Serialize(writer, batchProductsRequest.Products, jsonSerializerOptions);
        }
    }
}
