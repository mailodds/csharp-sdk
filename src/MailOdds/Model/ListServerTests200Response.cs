...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class ListServerTests200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListServerTests200Response" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="ListServerTests200Response" />
    /// </summary>
    public class ListServerTests200ResponseJsonConverter : JsonConverter<ListServerTests200Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="ListServerTests200Response" />
        /// </summary>
        ...
        public override ListServerTests200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class ListServerTests200Response.");
        ...
        /// <summary>
        /// Serializes a <see cref="ListServerTests200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listServerTests200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListServerTests200Response listServerTests200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listServerTests200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListServerTests200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listServerTests200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListServerTests200Response listServerTests200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listServerTests200Response.SchemaVersionOption.IsSet && listServerTests200Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(listServerTests200Response.SchemaVersion), "Property is required for class ListServerTests200Response.");
            ...
            if (listServerTests200Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", listServerTests200Response.SchemaVersion);
            ...
            if (listServerTests200Response.PaginationOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, listServerTests200Response.Pagination, jsonSerializerOptions);
            }
        }
    }
}
