...
namespace MailOdds.Model
{
    ...
    public partial class GetReputationTimeline200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetReputationTimeline200Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<List<Object>?> timeline = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<Object>?> TimelineOption { get; private set; }

        /// <summary>
        /// Gets or Sets Timeline
        /// </summary>
        [JsonPropertyName("timeline")]
        public List<Object>? Timeline { get { return this.TimelineOption; } set { this.TimelineOption = new(value); } }
    ...
    public class GetReputationTimeline200ResponseJsonConverter : JsonConverter<GetReputationTimeline200Response>
    {
        ...
        public override GetReputationTimeline200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Object>?> timeline = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "request_id":
                            ...
                            break;
                        case "timeline":
                            timeline = new Option<List<Object>?>(JsonSerializer.Deserialize<List<Object>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
