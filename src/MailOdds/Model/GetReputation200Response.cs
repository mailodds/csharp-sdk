...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class GetReputation200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetReputation200Response" /> class.
        /// </summary>
        /// <param name="schemaVersion">schemaVersion</param>
        /// <param name="requestId">requestId</param>
        /// <param name="reputation">reputation</param>
        [JsonConstructor]
        public GetReputation200Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<Object?> reputation = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetReputation200Response" />
    /// </summary>
    public class GetReputation200ResponseJsonConverter : JsonConverter<GetReputation200Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetReputation200Response" />
        /// </summary>
        ...
        public override GetReputation200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class GetReputation200Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class GetReputation200Response.");

            if (reputation.IsSet && reputation.Value == null)
                throw new ArgumentNullException(nameof(reputation), "Property is not nullable for class GetReputation200Response.");

            return new GetReputation200Response(schemaVersion, requestId, reputation);
        }

        /// <summary>
        /// Serializes a <see cref="GetReputation200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getReputation200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetReputation200Response getReputation200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getReputation200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetReputation200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getReputation200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetReputation200Response getReputation200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getReputation200Response.SchemaVersionOption.IsSet && getReputation200Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(getReputation200Response.SchemaVersion), "Property is required for class GetReputation200Response.");

            if (getReputation200Response.RequestIdOption.IsSet && getReputation200Response.RequestId == null)
                throw new ArgumentNullException(nameof(getReputation200Response.RequestId), "Property is required for class GetReputation200Response.");

            if (getReputation200Response.ReputationOption.IsSet && getReputation200Response.Reputation == null)
                throw new ArgumentNullException(nameof(getReputation200Response.Reputation), "Property is required for class GetReputation200Response.");

            if (getReputation200Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", getReputation200Response.SchemaVersion);

            if (getReputation200Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", getReputation200Response.RequestId);

            if (getReputation200Response.ReputationOption.IsSet)
            {
                writer.WritePropertyName("reputation");
                JsonSerializer.Serialize(writer, getReputation200Response.Reputation, jsonSerializerOptions);
            }
        }
    }
}
