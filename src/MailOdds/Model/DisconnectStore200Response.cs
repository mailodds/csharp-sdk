...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class DisconnectStore200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DisconnectStore200Response" /> class.
        /// </summary>
        /// <param name="schemaVersion">schemaVersion</param>
        /// <param name="requestId">requestId</param>
        /// <param name="disconnected">disconnected</param>
        [JsonConstructor]
        public DisconnectStore200Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<bool?> disconnected = default)
        {
            SchemaVersionOption = schemaVersion;
            RequestIdOption = requestId;
            DisconnectedOption = disconnected;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of Disconnected
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> DisconnectedOption { get; private set; }

        /// <summary>
        /// Gets or Sets Disconnected
        /// </summary>
        [JsonPropertyName("disconnected")]
        public bool? Disconnected { get { return this.DisconnectedOption; } set { this.DisconnectedOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DisconnectStore200Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="DisconnectStore200Response" />
    /// </summary>
    public class DisconnectStore200ResponseJsonConverter : JsonConverter<DisconnectStore200Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="DisconnectStore200Response" />
        /// </summary>
        ...
        public override DisconnectStore200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<bool?> disconnected = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "request_id":
                            ...
                            break;
                        case "disconnected":
                            disconnected = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class DisconnectStore200Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class DisconnectStore200Response.");

            if (disconnected.IsSet && disconnected.Value == null)
                throw new ArgumentNullException(nameof(disconnected), "Property is not nullable for class DisconnectStore200Response.");

            return new DisconnectStore200Response(schemaVersion, requestId, disconnected);
        }

        /// <summary>
        /// Serializes a <see cref="DisconnectStore200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="disconnectStore200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DisconnectStore200Response disconnectStore200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, disconnectStore200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DisconnectStore200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="disconnectStore200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DisconnectStore200Response disconnectStore200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (disconnectStore200Response.SchemaVersionOption.IsSet && disconnectStore200Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(disconnectStore200Response.SchemaVersion), "Property is required for class DisconnectStore200Response.");

            if (disconnectStore200Response.RequestIdOption.IsSet && disconnectStore200Response.RequestId == null)
                throw new ArgumentNullException(nameof(disconnectStore200Response.RequestId), "Property is required for class DisconnectStore200Response.");

            if (disconnectStore200Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", disconnectStore200Response.SchemaVersion);

            if (disconnectStore200Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", disconnectStore200Response.RequestId);

            if (disconnectStore200Response.DisconnectedOption.IsSet)
                writer.WriteBoolean("disconnected", disconnectStore200Response.DisconnectedOption.Value!.Value);
        }
    }
}
