...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class ServerTestMxRecordsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerTestMxRecordsInner" /> class.
        /// </summary>
        /// <param name="host">host</param>
        /// <param name="priority">priority</param>
        /// <param name="ip">ip</param>
        [JsonConstructor]
        public ServerTestMxRecordsInner(Option<string?> host = default, Option<int?> priority = default, Option<string?> ip = default)
        {
            HostOption = host;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ServerTestMxRecordsInner" />
    /// </summary>
    public class ServerTestMxRecordsInnerJsonConverter : JsonConverter<ServerTestMxRecordsInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="ServerTestMxRecordsInner" />
        /// </summary>
        ...
        public override ServerTestMxRecordsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (host.IsSet && host.Value == null)
                throw new ArgumentNullException(nameof(host), "Property is not nullable for class ServerTestMxRecordsInner.");

            if (priority.IsSet && priority.Value == null)
                throw new ArgumentNullException(nameof(priority), "Property is not nullable for class ServerTestMxRecordsInner.");

            if (ip.IsSet && ip.Value == null)
                throw new ArgumentNullException(nameof(ip), "Property is not nullable for class ServerTestMxRecordsInner.");

            return new ServerTestMxRecordsInner(host, priority, ip);
        }

        /// <summary>
        /// Serializes a <see cref="ServerTestMxRecordsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="serverTestMxRecordsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ServerTestMxRecordsInner serverTestMxRecordsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, serverTestMxRecordsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ServerTestMxRecordsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="serverTestMxRecordsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ServerTestMxRecordsInner serverTestMxRecordsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (serverTestMxRecordsInner.HostOption.IsSet && serverTestMxRecordsInner.Host == null)
                throw new ArgumentNullException(nameof(serverTestMxRecordsInner.Host), "Property is required for class ServerTestMxRecordsInner.");

            if (serverTestMxRecordsInner.IpOption.IsSet && serverTestMxRecordsInner.Ip == null)
                throw new ArgumentNullException(nameof(serverTestMxRecordsInner.Ip), "Property is required for class ServerTestMxRecordsInner.");

            if (serverTestMxRecordsInner.HostOption.IsSet)
                writer.WriteString("host", serverTestMxRecordsInner.Host);

            if (serverTestMxRecordsInner.PriorityOption.IsSet)
                writer.WriteNumber("priority", serverTestMxRecordsInner.PriorityOption.Value!.Value);

            if (serverTestMxRecordsInner.IpOption.IsSet)
                writer.WriteString("ip", serverTestMxRecordsInner.Ip);
        }
    }
}
