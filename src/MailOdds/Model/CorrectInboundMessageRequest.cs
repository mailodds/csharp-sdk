...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class CorrectInboundMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CorrectInboundMessageRequest" /> class.
        /// </summary>
        /// <param name="correction">Corrected classification label</param>
        [JsonConstructor]
        public CorrectInboundMessageRequest(string correction)
        {
        ...
        /// </summary>
        /// <value>Corrected classification label</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CorrectInboundMessageRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CorrectInboundMessageRequest" />
    /// </summary>
    public class CorrectInboundMessageRequestJsonConverter : JsonConverter<CorrectInboundMessageRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="CorrectInboundMessageRequest" />
        /// </summary>
        ...
        public override CorrectInboundMessageRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> correction = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "correction":
                            correction = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        default:
                            break;
                    }
            ...
            if (!correction.IsSet)
                throw new ArgumentException("Property is required for class CorrectInboundMessageRequest.", nameof(correction));

            if (correction.IsSet && correction.Value == null)
                throw new ArgumentNullException(nameof(correction), "Property is not nullable for class CorrectInboundMessageRequest.");

            return new CorrectInboundMessageRequest(correction.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="CorrectInboundMessageRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="correctInboundMessageRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CorrectInboundMessageRequest correctInboundMessageRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, correctInboundMessageRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CorrectInboundMessageRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="correctInboundMessageRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CorrectInboundMessageRequest correctInboundMessageRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (correctInboundMessageRequest.Correction == null)
                throw new ArgumentNullException(nameof(correctInboundMessageRequest.Correction), "Property is required for class CorrectInboundMessageRequest.");

            writer.WriteString("correction", correctInboundMessageRequest.Correction);
        }
    }
}
