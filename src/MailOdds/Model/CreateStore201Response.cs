...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class CreateStore201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStore201Response" /> class.
        /// </summary>
        /// <param name="schemaVersion">schemaVersion</param>
        /// <param name="requestId">requestId</param>
        /// <param name="store">store</param>
        [JsonConstructor]
        public CreateStore201Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<StoreConnection?> store = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<StoreConnection?> StoreOption { get; private set; }

        /// <summary>
        /// Gets or Sets Store
        /// </summary>
        [JsonPropertyName("store")]
        public StoreConnection? Store { get { return this.StoreOption; } set { this.StoreOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateStore201Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateStore201Response" />
    /// </summary>
    public class CreateStore201ResponseJsonConverter : JsonConverter<CreateStore201Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateStore201Response" />
        /// </summary>
        ...
        public override CreateStore201Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<StoreConnection?> store = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "request_id":
                            ...
                            break;
                        case "store":
                            store = new Option<StoreConnection?>(JsonSerializer.Deserialize<StoreConnection>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class CreateStore201Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class CreateStore201Response.");

            if (store.IsSet && store.Value == null)
                throw new ArgumentNullException(nameof(store), "Property is not nullable for class CreateStore201Response.");

            return new CreateStore201Response(schemaVersion, requestId, store);
        }

        /// <summary>
        /// Serializes a <see cref="CreateStore201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createStore201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateStore201Response createStore201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createStore201Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateStore201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createStore201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateStore201Response createStore201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createStore201Response.SchemaVersionOption.IsSet && createStore201Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(createStore201Response.SchemaVersion), "Property is required for class CreateStore201Response.");

            if (createStore201Response.RequestIdOption.IsSet && createStore201Response.RequestId == null)
                throw new ArgumentNullException(nameof(createStore201Response.RequestId), "Property is required for class CreateStore201Response.");

            if (createStore201Response.StoreOption.IsSet && createStore201Response.Store == null)
                throw new ArgumentNullException(nameof(createStore201Response.Store), "Property is required for class CreateStore201Response.");

            if (createStore201Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", createStore201Response.SchemaVersion);

            if (createStore201Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", createStore201Response.RequestId);

            if (createStore201Response.StoreOption.IsSet)
            {
                writer.WritePropertyName("store");
                JsonSerializer.Serialize(writer, createStore201Response.Store, jsonSerializerOptions);
            }
        }
    }
}
