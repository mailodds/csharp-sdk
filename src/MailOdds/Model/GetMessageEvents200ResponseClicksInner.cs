...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class GetMessageEvents200ResponseClicksInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageEvents200ResponseClicksInner" /> class.
        /// </summary>
        /// <param name="url">url</param>
        /// <param name="isBot">isBot</param>
        /// <param name="timestamp">timestamp</param>
        [JsonConstructor]
        public GetMessageEvents200ResponseClicksInner(Option<string?> url = default, Option<bool?> isBot = default, Option<DateTime?> timestamp = default)
        {
            UrlOption = url;
            IsBotOption = isBot;
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetMessageEvents200ResponseClicksInner" />
    /// </summary>
    public class GetMessageEvents200ResponseClicksInnerJsonConverter : JsonConverter<GetMessageEvents200ResponseClicksInner>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="GetMessageEvents200ResponseClicksInner" />
        /// </summary>
        ...
        public override GetMessageEvents200ResponseClicksInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (url.IsSet && url.Value == null)
                throw new ArgumentNullException(nameof(url), "Property is not nullable for class GetMessageEvents200ResponseClicksInner.");

            if (isBot.IsSet && isBot.Value == null)
                throw new ArgumentNullException(nameof(isBot), "Property is not nullable for class GetMessageEvents200ResponseClicksInner.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class GetMessageEvents200ResponseClicksInner.");

            return new GetMessageEvents200ResponseClicksInner(url, isBot, timestamp);
        }

        /// <summary>
        /// Serializes a <see cref="GetMessageEvents200ResponseClicksInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getMessageEvents200ResponseClicksInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetMessageEvents200ResponseClicksInner getMessageEvents200ResponseClicksInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getMessageEvents200ResponseClicksInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetMessageEvents200ResponseClicksInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getMessageEvents200ResponseClicksInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetMessageEvents200ResponseClicksInner getMessageEvents200ResponseClicksInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getMessageEvents200ResponseClicksInner.UrlOption.IsSet && getMessageEvents200ResponseClicksInner.Url == null)
                throw new ArgumentNullException(nameof(getMessageEvents200ResponseClicksInner.Url), "Property is required for class GetMessageEvents200ResponseClicksInner.");

            if (getMessageEvents200ResponseClicksInner.UrlOption.IsSet)
                writer.WriteString("url", getMessageEvents200ResponseClicksInner.Url);

            if (getMessageEvents200ResponseClicksInner.IsBotOption.IsSet)
                writer.WriteBoolean("is_bot", getMessageEvents200ResponseClicksInner.IsBotOption.Value!.Value);

            if (getMessageEvents200ResponseClicksInner.TimestampOption.IsSet)
                writer.WriteString("timestamp", getMessageEvents200ResponseClicksInner.TimestampOption.Value!.Value.ToString(TimestampFormat));
        }
    }
}
