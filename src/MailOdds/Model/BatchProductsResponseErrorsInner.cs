...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class BatchProductsResponseErrorsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchProductsResponseErrorsInner" /> class.
        /// </summary>
        /// <param name="externalId">externalId</param>
        /// <param name="error">error</param>
        [JsonConstructor]
        public BatchProductsResponseErrorsInner(Option<string?> externalId = default, Option<string?> error = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchProductsResponseErrorsInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="BatchProductsResponseErrorsInner" />
    /// </summary>
    public class BatchProductsResponseErrorsInnerJsonConverter : JsonConverter<BatchProductsResponseErrorsInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="BatchProductsResponseErrorsInner" />
        /// </summary>
        ...
        public override BatchProductsResponseErrorsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (externalId.IsSet && externalId.Value == null)
                throw new ArgumentNullException(nameof(externalId), "Property is not nullable for class BatchProductsResponseErrorsInner.");

            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class BatchProductsResponseErrorsInner.");

            return new BatchProductsResponseErrorsInner(externalId, error);
        }

        /// <summary>
        /// Serializes a <see cref="BatchProductsResponseErrorsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="batchProductsResponseErrorsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BatchProductsResponseErrorsInner batchProductsResponseErrorsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, batchProductsResponseErrorsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BatchProductsResponseErrorsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="batchProductsResponseErrorsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BatchProductsResponseErrorsInner batchProductsResponseErrorsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (batchProductsResponseErrorsInner.ExternalIdOption.IsSet && batchProductsResponseErrorsInner.ExternalId == null)
                throw new ArgumentNullException(nameof(batchProductsResponseErrorsInner.ExternalId), "Property is required for class BatchProductsResponseErrorsInner.");

            if (batchProductsResponseErrorsInner.ErrorOption.IsSet && batchProductsResponseErrorsInner.Error == null)
                throw new ArgumentNullException(nameof(batchProductsResponseErrorsInner.Error), "Property is required for class BatchProductsResponseErrorsInner.");

            if (batchProductsResponseErrorsInner.ExternalIdOption.IsSet)
                writer.WriteString("external_id", batchProductsResponseErrorsInner.ExternalId);

            if (batchProductsResponseErrorsInner.ErrorOption.IsSet)
                writer.WriteString("error", batchProductsResponseErrorsInner.Error);
        }
    }
}
