...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class BatchCheckOooRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchCheckOooRequest" /> class.
        /// </summary>
        /// <param name="emails">Email addresses to check</param>
        [JsonConstructor]
        public BatchCheckOooRequest(List<string> emails)
        {
            Emails = emails;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>Email addresses to check</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchCheckOooRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="BatchCheckOooRequest" />
    /// </summary>
    public class BatchCheckOooRequestJsonConverter : JsonConverter<BatchCheckOooRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="BatchCheckOooRequest" />
        /// </summary>
        ...
        public override BatchCheckOooRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!emails.IsSet)
                throw new ArgumentException("Property is required for class BatchCheckOooRequest.", nameof(emails));

            if (emails.IsSet && emails.Value == null)
                throw new ArgumentNullException(nameof(emails), "Property is not nullable for class BatchCheckOooRequest.");

            return new BatchCheckOooRequest(emails.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="BatchCheckOooRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="batchCheckOooRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BatchCheckOooRequest batchCheckOooRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, batchCheckOooRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BatchCheckOooRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="batchCheckOooRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BatchCheckOooRequest batchCheckOooRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (batchCheckOooRequest.Emails == null)
                throw new ArgumentNullException(nameof(batchCheckOooRequest.Emails), "Property is required for class BatchCheckOooRequest.");

            writer.WritePropertyName("emails");
            JsonSerializer.Serialize(writer, batchCheckOooRequest.Emails, jsonSerializerOptions);
        }
    }
}
