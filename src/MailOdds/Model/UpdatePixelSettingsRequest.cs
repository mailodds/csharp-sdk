...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class UpdatePixelSettingsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePixelSettingsRequest" /> class.
        /// </summary>
        /// <param name="pixelSubscribeListId">Contact list ID for pixel subscriptions, or null to disable</param>
        [JsonConstructor]
        public UpdatePixelSettingsRequest(int? pixelSubscribeListId = default)
        {
            PixelSubscribeListId = pixelSubscribeListId;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>Contact list ID for pixel subscriptions, or null to disable</value>
        [JsonPropertyName("pixel_subscribe_list_id")]
        public int? PixelSubscribeListId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePixelSettingsRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdatePixelSettingsRequest" />
    /// </summary>
    public class UpdatePixelSettingsRequestJsonConverter : JsonConverter<UpdatePixelSettingsRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdatePixelSettingsRequest" />
        /// </summary>
        ...
        public override UpdatePixelSettingsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!pixelSubscribeListId.IsSet)
                throw new ArgumentException("Property is required for class UpdatePixelSettingsRequest.", nameof(pixelSubscribeListId));

            return new UpdatePixelSettingsRequest(pixelSubscribeListId.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="UpdatePixelSettingsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updatePixelSettingsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdatePixelSettingsRequest updatePixelSettingsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updatePixelSettingsRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdatePixelSettingsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updatePixelSettingsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdatePixelSettingsRequest updatePixelSettingsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updatePixelSettingsRequest.PixelSubscribeListId != null)
                writer.WriteNumber("pixel_subscribe_list_id", updatePixelSettingsRequest.PixelSubscribeListId.Value);
            else
