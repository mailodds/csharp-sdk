...
namespace MailOdds.Model
{
    ...
    /// </summary>
    public partial class GetBounceStatsSummary200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBounceStatsSummary200Response" /> class.
        /// </summary>
        /// <param name="schemaVersion">schemaVersion</param>
        /// <param name="requestId">requestId</param>
        /// <param name="summary">summary</param>
        [JsonConstructor]
        public GetBounceStatsSummary200Response(Option<string?> schemaVersion = default, Option<string?> requestId = default, Option<Object?> summary = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBounceStatsSummary200Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetBounceStatsSummary200Response" />
    /// </summary>
    public class GetBounceStatsSummary200ResponseJsonConverter : JsonConverter<GetBounceStatsSummary200Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetBounceStatsSummary200Response" />
        /// </summary>
        ...
        public override GetBounceStatsSummary200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (schemaVersion.IsSet && schemaVersion.Value == null)
                throw new ArgumentNullException(nameof(schemaVersion), "Property is not nullable for class GetBounceStatsSummary200Response.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class GetBounceStatsSummary200Response.");

            if (summary.IsSet && summary.Value == null)
                throw new ArgumentNullException(nameof(summary), "Property is not nullable for class GetBounceStatsSummary200Response.");

            return new GetBounceStatsSummary200Response(schemaVersion, requestId, summary);
        }

        /// <summary>
        /// Serializes a <see cref="GetBounceStatsSummary200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getBounceStatsSummary200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetBounceStatsSummary200Response getBounceStatsSummary200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getBounceStatsSummary200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetBounceStatsSummary200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getBounceStatsSummary200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetBounceStatsSummary200Response getBounceStatsSummary200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getBounceStatsSummary200Response.SchemaVersionOption.IsSet && getBounceStatsSummary200Response.SchemaVersion == null)
                throw new ArgumentNullException(nameof(getBounceStatsSummary200Response.SchemaVersion), "Property is required for class GetBounceStatsSummary200Response.");

            if (getBounceStatsSummary200Response.RequestIdOption.IsSet && getBounceStatsSummary200Response.RequestId == null)
                throw new ArgumentNullException(nameof(getBounceStatsSummary200Response.RequestId), "Property is required for class GetBounceStatsSummary200Response.");

            if (getBounceStatsSummary200Response.SummaryOption.IsSet && getBounceStatsSummary200Response.Summary == null)
                throw new ArgumentNullException(nameof(getBounceStatsSummary200Response.Summary), "Property is required for class GetBounceStatsSummary200Response.");

            if (getBounceStatsSummary200Response.SchemaVersionOption.IsSet)
                writer.WriteString("schema_version", getBounceStatsSummary200Response.SchemaVersion);

            if (getBounceStatsSummary200Response.RequestIdOption.IsSet)
                writer.WriteString("request_id", getBounceStatsSummary200Response.RequestId);

            if (getBounceStatsSummary200Response.SummaryOption.IsSet)
            {
                writer.WritePropertyName("summary");
                JsonSerializer.Serialize(writer, getBounceStatsSummary200Response.Summary, jsonSerializerOptions);
            }
        }
    }
}
