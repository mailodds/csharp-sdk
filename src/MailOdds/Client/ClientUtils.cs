...
[assembly: InternalsVisibleTo("MailOdds.Test")]
...
namespace MailOdds.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is ValidationResultSuppression.MatchTypeEnum validationResultSuppressionMatchTypeEnum)
                return ValidationResultSuppression.MatchTypeEnumToJsonValue(validationResultSuppressionMatchTypeEnum);
            if (obj is WebhookEvent.EventEnum webhookEventEventEnum)
                return WebhookEvent.EventEnumToJsonValue(webhookEventEventEnum);
            if (obj is WebhookEvent.BounceTypeEnum webhookEventBounceTypeEnum)
                return WebhookEvent.BounceTypeEnumToJsonValue(webhookEventBounceTypeEnum);
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "api.mailodds.com";
