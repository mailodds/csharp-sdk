...
namespace MailOdds.Test.Api
{
    ...
    /// </summary>
    public sealed class AlertRulesApiTests : ApiTestsBase
    {
        private readonly IAlertRulesApi _instance;

        public AlertRulesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IAlertRulesApi>();
        }
        ...
        public async Task CreateAlertRuleAsyncTest()
        {
            CreateAlertRuleRequest createAlertRuleRequest = default!;
            var response = await _instance.CreateAlertRuleAsync(createAlertRuleRequest);
            var model = response.Created();
            Assert.IsType<CreateAlertRule201Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteAlertRuleAsyncTest()
        {
            string ruleId = default!;
            var response = await _instance.DeleteAlertRuleAsync(ruleId);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetAlertRuleAsyncTest()
        {
            string ruleId = default!;
            var response = await _instance.GetAlertRuleAsync(ruleId);
            var model = response.Ok();
            Assert.IsType<CreateAlertRule201Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListAlertRulesAsyncTest()
        {
            var response = await _instance.ListAlertRulesAsync();
            var model = response.Ok();
            Assert.IsType<ListAlertRules200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateAlertRuleAsyncTest()
        {
            string ruleId = default!;
            UpdateAlertRuleRequest updateAlertRuleRequest = default!;
            var response = await _instance.UpdateAlertRuleAsync(ruleId, updateAlertRuleRequest);
            var model = response.Ok();
            Assert.IsType<CreateAlertRule201Response>(model);
        }
    }
