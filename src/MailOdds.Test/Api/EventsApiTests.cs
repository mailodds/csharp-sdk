...
namespace MailOdds.Test.Api
{
    ...
    public sealed class EventsApiTests : ApiTestsBase
    {
        ...
        public async Task TrackEventAsyncTest()
        {
            TrackEventRequest trackEventRequest = default!;
            var response = await _instance.TrackEventAsync(trackEventRequest);
            var model = response.Created();
            Assert.IsType<TrackEventResponse>(model);
        }
    }
}
