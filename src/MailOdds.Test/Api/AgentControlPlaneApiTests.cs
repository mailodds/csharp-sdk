...
{
    /// <summary>
    ///  Class for testing AgentControlPlaneApi
    /// </summary>
    public sealed class AgentControlPlaneApiTests : ApiTestsBase
    {
        private readonly IAgentControlPlaneApi _instance;

        public AgentControlPlaneApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IAgentControlPlaneApi>();
        }

        /// <summary>
        /// Test GetMcpCapabilities
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetMcpCapabilitiesAsyncTest()
        {
            var response = await _instance.GetMcpCapabilitiesAsync();
            var model = response.Ok();
            Assert.IsType<McpCapabilities>(model);
        }
    }
}
