...
{
    /// <summary>
    ///  Class for testing ServerTestsApi
    /// </summary>
    public sealed class ServerTestsApiTests : ApiTestsBase
    {
        private readonly IServerTestsApi _instance;

        public ServerTestsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IServerTestsApi>();
        }
        ...
        public async Task GetServerTestAsyncTest()
        {
            string testId = default!;
            var response = await _instance.GetServerTestAsync(testId);
            var model = response.Ok();
            Assert.IsType<RunServerTest201Response>(model);
        }

        /// <summary>
        /// Test ListServerTests
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListServerTestsAsyncTest()
        {
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            var response = await _instance.ListServerTestsAsync(page, perPage);
            var model = response.Ok();
            Assert.IsType<ListServerTests200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RunServerTestAsyncTest()
        {
            RunServerTestRequest runServerTestRequest = default!;
            var response = await _instance.RunServerTestAsync(runServerTestRequest);
