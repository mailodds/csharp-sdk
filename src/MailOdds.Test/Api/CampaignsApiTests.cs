...
namespace MailOdds.Test.Api
{
    ...
    public sealed class CampaignsApiTests : ApiTestsBase
    {
        ...
        public async Task CancelCampaignAsyncTest()
        {
            string campaignId = default!;
            var response = await _instance.CancelCampaignAsync(campaignId);
        ...
        public async Task CreateCampaignAsyncTest()
        {
            ...
            var response = await _instance.CreateCampaignAsync(createCampaignRequest);
            var model = response.Created();
            Assert.IsType<CampaignResponse>(model);
        }

        /// <summary>
        /// Test CreateCampaignVariant
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateCampaignVariantAsyncTest()
        {
            string campaignId = default!;
            CreateVariantRequest createVariantRequest = default!;
            var response = await _instance.CreateCampaignVariantAsync(campaignId, createVariantRequest);
            var model = response.Created();
            Assert.IsType<CreateCampaignVariant201Response>(model);
        }
        ...
        {
            string campaignId = default!;
            var response = await _instance.GetCampaignAsync(campaignId);
            var model = response.Ok();
            Assert.IsType<CampaignResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListCampaignsAsyncTest()
        {
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            Client.Option<string> status = default!;
            var response = await _instance.ListCampaignsAsync(page, perPage, status);
            var model = response.Ok();
            Assert.IsType<ListCampaigns200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ScheduleCampaignAsyncTest()
        {
            string campaignId = default!;
            ScheduleCampaignRequest scheduleCampaignRequest = default!;
            var response = await _instance.ScheduleCampaignAsync(campaignId, scheduleCampaignRequest);
            var model = response.Ok();
            Assert.IsType<CampaignResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SendCampaignAsyncTest()
        {
            string campaignId = default!;
            var response = await _instance.SendCampaignAsync(campaignId);
