...
{
    /// <summary>
    ///  Class for testing GlobalSuppressionsApi
    /// </summary>
    public sealed class GlobalSuppressionsApiTests : ApiTestsBase
    {
        private readonly IGlobalSuppressionsApi _instance;

        public GlobalSuppressionsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IGlobalSuppressionsApi>();
        }

        /// <summary>
        /// Test AddGlobalSuppressionOverride
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddGlobalSuppressionOverrideAsyncTest()
        {
            await _instance.AddGlobalSuppressionOverrideAsync();
        }

        /// <summary>
        /// Test CheckGlobalSuppression
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CheckGlobalSuppressionAsyncTest()
        {
            await _instance.CheckGlobalSuppressionAsync();
        }

        /// <summary>
        /// Test RemoveGlobalSuppressionOverride
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RemoveGlobalSuppressionOverrideAsyncTest()
        {
            await _instance.RemoveGlobalSuppressionOverrideAsync();
        }
    }
}
