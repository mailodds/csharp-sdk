...
{
    /// <summary>
    ///  Class for testing InboundProcessingApi
    /// </summary>
    public sealed class InboundProcessingApiTests : ApiTestsBase
    {
        private readonly IInboundProcessingApi _instance;

        public InboundProcessingApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IInboundProcessingApi>();
        }

        /// <summary>
        /// Test CorrectInboundMessage
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CorrectInboundMessageAsyncTest()
        {
            string messageId = default!;
            CorrectInboundMessageRequest correctInboundMessageRequest = default!;
            var response = await _instance.CorrectInboundMessageAsync(messageId, correctInboundMessageRequest);
            var model = response.Ok();
            Assert.IsType<GetInboundMessage200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetBounceStatsAsyncTest()
        {
            Client.Option<string> domainId = default!;
            Client.Option<string> period = default!;
            Client.Option<string> groupBy = default!;
            var response = await _instance.GetBounceStatsAsync(domainId, period, groupBy);
            var model = response.Ok();
            Assert.IsType<GetBounceStats200Response>(model);
        }

        /// <summary>
        /// Test GetBounceStatsSummary
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetBounceStatsSummaryAsyncTest()
        {
            Client.Option<string> domainId = default!;
            Client.Option<string> period = default!;
            var response = await _instance.GetBounceStatsSummaryAsync(domainId, period);
            var model = response.Ok();
            Assert.IsType<GetBounceStatsSummary200Response>(model);
        }

        /// <summary>
        /// Test GetComplaintAssessment
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetComplaintAssessmentAsyncTest()
        {
            Client.Option<string> domainId = default!;
            Client.Option<string> period = default!;
            var response = await _instance.GetComplaintAssessmentAsync(domainId, period);
            var model = response.Ok();
            Assert.IsType<GetComplaintAssessment200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetInboundMessageAsyncTest()
        {
            string messageId = default!;
            var response = await _instance.GetInboundMessageAsync(messageId);
            var model = response.Ok();
            Assert.IsType<GetInboundMessage200Response>(model);
        }

        /// <summary>
        /// Test ListInboundMessages
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListInboundMessagesAsyncTest()
        {
            Client.Option<string> category = default!;
            Client.Option<string> domainId = default!;
            Client.Option<DateTime> since = default!;
            Client.Option<DateTime> until = default!;
            Client.Option<bool> isRead = default!;
            ...
            var response = await _instance.ListInboundMessagesAsync(category, domainId, since, until, isRead, recipient, search, page, perPage);
            var model = response.Ok();
            Assert.IsType<ListInboundMessages200Response>(model);
        }
    }
}
