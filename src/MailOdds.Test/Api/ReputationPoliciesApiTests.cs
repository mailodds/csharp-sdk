...
{
    /// <summary>
    ///  Class for testing ReputationPoliciesApi
    /// </summary>
    public sealed class ReputationPoliciesApiTests : ApiTestsBase
    {
        private readonly IReputationPoliciesApi _instance;

        public ReputationPoliciesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IReputationPoliciesApi>();
        }

        /// <summary>
        /// Test CreateReputationPolicy
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateReputationPolicyAsyncTest()
        {
            await _instance.CreateReputationPolicyAsync();
        }

        /// <summary>
        /// Test CreateReputationPolicyFromPreset
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateReputationPolicyFromPresetAsyncTest()
        {
            await _instance.CreateReputationPolicyFromPresetAsync();
        }

        /// <summary>
        /// Test DeleteReputationPolicy
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteReputationPolicyAsyncTest()
        {
            string policyId = default!;
            await _instance.DeleteReputationPolicyAsync(policyId);
        }

        /// <summary>
        /// Test GetReputationPolicy
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetReputationPolicyAsyncTest()
        {
            string policyId = default!;
            await _instance.GetReputationPolicyAsync(policyId);
        }

        /// <summary>
        /// Test GetReputationPolicyStatus
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetReputationPolicyStatusAsyncTest()
        {
            string policyId = default!;
            await _instance.GetReputationPolicyStatusAsync(policyId);
        }

        /// <summary>
        /// Test ListReputationPolicies
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListReputationPoliciesAsyncTest()
        {
            await _instance.ListReputationPoliciesAsync();
        }

        /// <summary>
        /// Test TestReputationPolicy
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task TestReputationPolicyAsyncTest()
        {
            string policyId = default!;
            await _instance.TestReputationPolicyAsync(policyId);
        }

        /// <summary>
        /// Test UpdateReputationPolicy
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateReputationPolicyAsyncTest()
        {
            string policyId = default!;
            await _instance.UpdateReputationPolicyAsync(policyId);
        }
    }
}
