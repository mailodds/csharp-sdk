...
{
    /// <summary>
    ///  Class for testing SpamChecksApi
    /// </summary>
    public sealed class SpamChecksApiTests : ApiTestsBase
    {
        private readonly ISpamChecksApi _instance;

        public SpamChecksApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISpamChecksApi>();
        }
        ...
        public async Task GetSpamCheckAsyncTest()
        {
            string checkId = default!;
            var response = await _instance.GetSpamCheckAsync(checkId);
            var model = response.Ok();
            Assert.IsType<RunSpamCheck201Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListSpamChecksAsyncTest()
        {
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            var response = await _instance.ListSpamChecksAsync(page, perPage);
            var model = response.Ok();
            Assert.IsType<ListSpamChecks200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RunSpamCheckAsyncTest()
        {
            RunSpamCheckRequest runSpamCheckRequest = default!;
            var response = await _instance.RunSpamCheckAsync(runSpamCheckRequest);
