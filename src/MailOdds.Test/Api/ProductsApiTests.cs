...
namespace MailOdds.Test.Api
{
    ...
    public sealed class ProductsApiTests : ApiTestsBase
    {
        ...
        public async Task BatchProductsAsyncTest()
        {
            string storeId = default!;
            BatchProductsRequest batchProductsRequest = default!;
            var response = await _instance.BatchProductsAsync(storeId, batchProductsRequest);
            var model = response.Ok();
            Assert.IsType<BatchProductsResponse>(model);
        }
        ...
        public async Task GetProductAsyncTest()
        {
            ...
            var response = await _instance.GetProductAsync(productId);
            var model = response.Ok();
            Assert.IsType<GetProduct200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task QueryProductsAsyncTest()
        {
            Client.Option<string> storeId = default!;
            Client.Option<string> category = default!;
            Client.Option<string> stockStatus = default!;
            Client.Option<bool> onSale = default!;
            Client.Option<string> search = default!;
            Client.Option<bool> facets = default!;
            Client.Option<bool> groupBySku = default!;
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            var response = await _instance.QueryProductsAsync(storeId, category, stockStatus, onSale, search, facets, groupBySku, page, perPage);
            var model = response.Ok();
            Assert.IsType<QueryProducts200Response>(model);
        }
    }
}
