...
{
    /// <summary>
    ///  Class for testing PixelSettingsApi
    /// </summary>
    public sealed class PixelSettingsApiTests : ApiTestsBase
    {
        private readonly IPixelSettingsApi _instance;

        public PixelSettingsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IPixelSettingsApi>();
        }

        /// <summary>
        /// Test GetPixelSettings
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetPixelSettingsAsyncTest()
        {
            var response = await _instance.GetPixelSettingsAsync();
            var model = response.Ok();
            Assert.IsType<GetPixelSettings200Response>(model);
        }

        /// <summary>
        /// Test UpdatePixelSettings
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdatePixelSettingsAsyncTest()
        {
            UpdatePixelSettingsRequest updatePixelSettingsRequest = default!;
            var response = await _instance.UpdatePixelSettingsAsync(updatePixelSettingsRequest);
            var model = response.Ok();
            Assert.IsType<GetPixelSettings200Response>(model);
        }
    }
