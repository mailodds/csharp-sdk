...
{
    /// <summary>
    ///  Class for testing WebhookCLIApi
    /// </summary>
    public sealed class WebhookCLIApiTests : ApiTestsBase
    {
        private readonly IWebhookCLIApi _instance;

        public WebhookCLIApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IWebhookCLIApi>();
        }

        /// <summary>
        /// Test CreateWebhookCliSession
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateWebhookCliSessionAsyncTest()
        {
            Client.Option<CreateWebhookCliSessionRequest> createWebhookCliSessionRequest = default!;
            var response = await _instance.CreateWebhookCliSessionAsync(createWebhookCliSessionRequest);
            var model = response.Created();
            Assert.IsType<CreateWebhookCliSession201Response>(model);
        }

        /// <summary>
        /// Test DeleteWebhookCliSession
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteWebhookCliSessionAsyncTest()
        {
            string sessionId = default!;
            var response = await _instance.DeleteWebhookCliSessionAsync(sessionId);
            var model = response.Ok();
            Assert.IsType<DeleteWebhookCliSession200Response>(model);
        }
        ...
        public async Task ListWebhookDeliveriesAsyncTest()
        {
            ...
            var response = await _instance.ListWebhookDeliveriesAsync(limit);
            var model = response.Ok();
            Assert.IsType<ListWebhookDeliveries200Response>(model);
        }

        /// <summary>
        /// Test ReplayWebhookDelivery
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ReplayWebhookDeliveryAsyncTest()
        {
            int deliveryId = default!;
            var response = await _instance.ReplayWebhookDeliveryAsync(deliveryId);
            var model = response.Ok();
            Assert.IsType<ReplayWebhookDelivery200Response>(model);
        }
    }
}
