...
{
    /// <summary>
    ///  Class for testing ConfigurationSetsApi
    /// </summary>
    public sealed class ConfigurationSetsApiTests : ApiTestsBase
    {
        private readonly IConfigurationSetsApi _instance;

        public ConfigurationSetsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IConfigurationSetsApi>();
        }

        /// <summary>
        /// Test CreateConfigurationSet
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateConfigurationSetAsyncTest()
        {
            await _instance.CreateConfigurationSetAsync();
        }

        /// <summary>
        /// Test DeleteConfigurationSet
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteConfigurationSetAsyncTest()
        {
            string name = default!;
            await _instance.DeleteConfigurationSetAsync(name);
        }

        /// <summary>
        /// Test GetConfigurationSet
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetConfigurationSetAsyncTest()
        {
            string name = default!;
            await _instance.GetConfigurationSetAsync(name);
        }

        /// <summary>
        /// Test GetConfigurationSetMetrics
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetConfigurationSetMetricsAsyncTest()
        {
            string name = default!;
            await _instance.GetConfigurationSetMetricsAsync(name);
        }

        /// <summary>
        /// Test ListConfigurationSets
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListConfigurationSetsAsyncTest()
        {
            await _instance.ListConfigurationSetsAsync();
        }

        /// <summary>
        /// Test UpdateConfigurationSet
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateConfigurationSetAsyncTest()
        {
            string name = default!;
            await _instance.UpdateConfigurationSetAsync(name);
        }
    }
}
