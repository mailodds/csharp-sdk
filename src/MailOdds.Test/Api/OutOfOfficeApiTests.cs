...
{
    /// <summary>
    ///  Class for testing OutOfOfficeApi
    /// </summary>
    public sealed class OutOfOfficeApiTests : ApiTestsBase
    {
        private readonly IOutOfOfficeApi _instance;

        public OutOfOfficeApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IOutOfOfficeApi>();
        }
        ...
        public async Task BatchCheckOooAsyncTest()
        {
            BatchCheckOooRequest batchCheckOooRequest = default!;
            var response = await _instance.BatchCheckOooAsync(batchCheckOooRequest);
            var model = response.Ok();
            Assert.IsType<BatchCheckOoo200Response>(model);
        }

        /// <summary>
        /// Test DeleteOooContact
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteOooContactAsyncTest()
        {
            string email = default!;
            var response = await _instance.DeleteOooContactAsync(email);
            var model = response.Ok();
            Assert.IsType<DeleteOooContact200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOooStatusAsyncTest()
        {
            string email = default!;
            var response = await _instance.GetOooStatusAsync(email);
            var model = response.Ok();
            Assert.IsType<GetOooStatus200Response>(model);
        }

        /// <summary>
        /// Test ListOooContacts
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListOooContactsAsyncTest()
        {
            Client.Option<bool> activeOnly = default!;
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            var response = await _instance.ListOooContactsAsync(activeOnly, page, perPage);
            var model = response.Ok();
            Assert.IsType<ListOooContacts200Response>(model);
        }

        /// <summary>
        /// Test UpdateOooContact
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateOooContactAsyncTest()
        {
            string email = default!;
            UpdateOooContactRequest updateOooContactRequest = default!;
            var response = await _instance.UpdateOooContactAsync(email, updateOooContactRequest);
            var model = response.Ok();
