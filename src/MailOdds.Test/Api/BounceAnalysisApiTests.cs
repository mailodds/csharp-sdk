...
{
    /// <summary>
    ///  Class for testing BounceAnalysisApi
    /// </summary>
    public sealed class BounceAnalysisApiTests : ApiTestsBase
    {
        private readonly IBounceAnalysisApi _instance;

        public BounceAnalysisApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IBounceAnalysisApi>();
        }

        /// <summary>
        /// Test CreateBounceAnalysis
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateBounceAnalysisAsyncTest()
        {
            CreateBounceAnalysisRequest createBounceAnalysisRequest = default!;
            var response = await _instance.CreateBounceAnalysisAsync(createBounceAnalysisRequest);
            var model = response.Created();
            Assert.IsType<BounceAnalysisResponse>(model);
        }

        /// <summary>
        /// Test CrossReferenceBounces
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CrossReferenceBouncesAsyncTest()
        {
            string analysisId = default!;
            var response = await _instance.CrossReferenceBouncesAsync(analysisId);
            var model = response.Ok();
            Assert.IsType<CrossReferenceBounces200Response>(model);
        }

        /// <summary>
        /// Test GetBounceAnalysis
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetBounceAnalysisAsyncTest()
        {
            string analysisId = default!;
            var response = await _instance.GetBounceAnalysisAsync(analysisId);
            var model = response.Ok();
            Assert.IsType<BounceAnalysisResponse>(model);
        }

        /// <summary>
        /// Test GetBounceRecords
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetBounceRecordsAsyncTest()
        {
            string analysisId = default!;
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            Client.Option<string> type = default!;
            var response = await _instance.GetBounceRecordsAsync(analysisId, page, perPage, type);
            var model = response.Ok();
            Assert.IsType<GetBounceRecords200Response>(model);
        }
    }
}
