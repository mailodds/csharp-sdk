...
{
    /// <summary>
    ///  Class for testing DKIMManagementApi
    /// </summary>
    public sealed class DKIMManagementApiTests : ApiTestsBase
    {
        private readonly IDKIMManagementApi _instance;

        public DKIMManagementApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IDKIMManagementApi>();
        }

        /// <summary>
        /// Test GetDkimDnsRecord
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDkimDnsRecordAsyncTest()
        {
            string domainId = default!;
            await _instance.GetDkimDnsRecordAsync(domainId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RotateDkimAsyncTest()
        {
            string domainId = default!;
            await _instance.RotateDkimAsync(domainId);
        }
    }
}
