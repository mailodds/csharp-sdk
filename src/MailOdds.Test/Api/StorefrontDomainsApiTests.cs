...
{
    /// <summary>
    ///  Class for testing StorefrontDomainsApi
    /// </summary>
    public sealed class StorefrontDomainsApiTests : ApiTestsBase
    {
        private readonly IStorefrontDomainsApi _instance;

        public StorefrontDomainsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IStorefrontDomainsApi>();
        }

        /// <summary>
        /// Test CreateStorefrontDomain
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateStorefrontDomainAsyncTest()
        {
            CreateStorefrontDomainRequest createStorefrontDomainRequest = default!;
            await _instance.CreateStorefrontDomainAsync(createStorefrontDomainRequest);
        }

        /// <summary>
        /// Test DeleteStorefrontDomain
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteStorefrontDomainAsyncTest()
        {
            string domainId = default!;
            await _instance.DeleteStorefrontDomainAsync(domainId);
        }

        /// <summary>
        /// Test GetStorefrontDomain
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetStorefrontDomainAsyncTest()
        {
            string domainId = default!;
            await _instance.GetStorefrontDomainAsync(domainId);
        }

        /// <summary>
        /// Test ListStorefrontDomains
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListStorefrontDomainsAsyncTest()
        {
            await _instance.ListStorefrontDomainsAsync();
        }

        /// <summary>
        /// Test VerifyStorefrontDomain
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task VerifyStorefrontDomainAsyncTest()
        {
            string domainId = default!;
            await _instance.VerifyStorefrontDomainAsync(domainId);
        }
    }
}
