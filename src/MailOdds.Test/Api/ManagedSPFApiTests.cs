...
{
    /// <summary>
    ///  Class for testing ManagedSPFApi
    /// </summary>
    public sealed class ManagedSPFApiTests : ApiTestsBase
    {
        private readonly IManagedSPFApi _instance;

        public ManagedSPFApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IManagedSPFApi>();
        }

        /// <summary>
        /// Test CreateManagedSpf
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateManagedSpfAsyncTest()
        {
            string domainId = default!;
            await _instance.CreateManagedSpfAsync(domainId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetManagedSpfAsyncTest()
        {
            string domainId = default!;
            await _instance.GetManagedSpfAsync(domainId);
        }

        /// <summary>
        /// Test RefreshManagedSpf
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RefreshManagedSpfAsyncTest()
        {
            string domainId = default!;
            await _instance.RefreshManagedSpfAsync(domainId);
        }

        /// <summary>
        /// Test UpdateManagedSpf
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateManagedSpfAsyncTest()
        {
            string domainId = default!;
            await _instance.UpdateManagedSpfAsync(domainId);
        }
    }
}
