...
{
    /// <summary>
    ///  Class for testing EventDestinationsApi
    /// </summary>
    public sealed class EventDestinationsApiTests : ApiTestsBase
    {
        private readonly IEventDestinationsApi _instance;

        public EventDestinationsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IEventDestinationsApi>();
        }

        /// <summary>
        /// Test CreateEventDestination
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateEventDestinationAsyncTest()
        {
            await _instance.CreateEventDestinationAsync();
        }

        /// <summary>
        /// Test DeleteEventDestination
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteEventDestinationAsyncTest()
        {
            int destinationId = default!;
            await _instance.DeleteEventDestinationAsync(destinationId);
        }

        /// <summary>
        /// Test GetEventDestination
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetEventDestinationAsyncTest()
        {
            int destinationId = default!;
            await _instance.GetEventDestinationAsync(destinationId);
        }

        /// <summary>
        /// Test ListEventDestinationTemplates
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListEventDestinationTemplatesAsyncTest()
        {
            await _instance.ListEventDestinationTemplatesAsync();
        }

        /// <summary>
        /// Test ListEventDestinations
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListEventDestinationsAsyncTest()
        {
            await _instance.ListEventDestinationsAsync();
        }

        /// <summary>
        /// Test ListEventSchemas
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListEventSchemasAsyncTest()
        {
            await _instance.ListEventSchemasAsync();
        }

        /// <summary>
        /// Test UpdateEventDestination
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateEventDestinationAsyncTest()
        {
            int destinationId = default!;
            await _instance.UpdateEventDestinationAsync(destinationId);
        }
    }
}
