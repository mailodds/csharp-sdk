...
{
    /// <summary>
    ///  Class for testing DeliverabilityAdvisorApi
    /// </summary>
    public sealed class DeliverabilityAdvisorApiTests : ApiTestsBase
    {
        private readonly IDeliverabilityAdvisorApi _instance;

        public DeliverabilityAdvisorApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IDeliverabilityAdvisorApi>();
        }

        /// <summary>
        /// Test DismissDeliverabilityRecommendation
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DismissDeliverabilityRecommendationAsyncTest()
        {
            string recommendationId = default!;
            await _instance.DismissDeliverabilityRecommendationAsync(recommendationId);
        }

        /// <summary>
        /// Test GetDeliverabilityRecommendations
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDeliverabilityRecommendationsAsyncTest()
        {
            await _instance.GetDeliverabilityRecommendationsAsync();
        }
    }
}
