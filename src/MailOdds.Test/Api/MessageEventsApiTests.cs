...
{
    /// <summary>
    ///  Class for testing MessageEventsApi
    /// </summary>
    public sealed class MessageEventsApiTests : ApiTestsBase
    {
        private readonly IMessageEventsApi _instance;

        public MessageEventsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IMessageEventsApi>();
        }

        /// <summary>
        /// Test GetMessageEvents
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetMessageEventsAsyncTest()
        {
            string messageId = default!;
            var response = await _instance.GetMessageEventsAsync(messageId);
            var model = response.Ok();
            Assert.IsType<GetMessageEvents200Response>(model);
        }
    }
}
