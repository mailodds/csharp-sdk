...
{
    /// <summary>
    ///  Class for testing DMARCMonitoringApi
    /// </summary>
    public sealed class DMARCMonitoringApiTests : ApiTestsBase
    {
        private readonly IDMARCMonitoringApi _instance;

        public DMARCMonitoringApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IDMARCMonitoringApi>();
        }
        ...
        public async Task AddDmarcDomainAsyncTest()
        {
            AddDmarcDomainRequest addDmarcDomainRequest = default!;
            var response = await _instance.AddDmarcDomainAsync(addDmarcDomainRequest);
            var model = response.Created();
            Assert.IsType<AddDmarcDomain201Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDmarcDomainAsyncTest()
        {
            string domainId = default!;
            Client.Option<int> days = default!;
            var response = await _instance.GetDmarcDomainAsync(domainId, days);
            var model = response.Ok();
            Assert.IsType<GetDmarcDomain200Response>(model);
        }

        /// <summary>
        /// Test GetDmarcRecommendation
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDmarcRecommendationAsyncTest()
        {
            string domainId = default!;
            var response = await _instance.GetDmarcRecommendationAsync(domainId);
            var model = response.Ok();
            Assert.IsType<GetDmarcRecommendation200Response>(model);
        }

        /// <summary>
        /// Test GetDmarcSources
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDmarcSourcesAsyncTest()
        {
            string domainId = default!;
            Client.Option<int> days = default!;
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            var response = await _instance.GetDmarcSourcesAsync(domainId, days, page, perPage);
            var model = response.Ok();
            Assert.IsType<GetDmarcSources200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDmarcTrendAsyncTest()
        {
            string domainId = default!;
            Client.Option<int> days = default!;
            var response = await _instance.GetDmarcTrendAsync(domainId, days);
            var model = response.Ok();
            Assert.IsType<GetDmarcTrend200Response>(model);
        }

        /// <summary>
        /// Test ListDmarcDomains
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListDmarcDomainsAsyncTest()
        {
            var response = await _instance.ListDmarcDomainsAsync();
            var model = response.Ok();
            Assert.IsType<ListDmarcDomains200Response>(model);
        }

        /// <summary>
        /// Test VerifyDmarcDomain
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task VerifyDmarcDomainAsyncTest()
        {
            string domainId = default!;
            var response = await _instance.VerifyDmarcDomainAsync(domainId);
            var model = response.Ok();
            Assert.IsType<AddDmarcDomain201Response>(model);
        }
    }
