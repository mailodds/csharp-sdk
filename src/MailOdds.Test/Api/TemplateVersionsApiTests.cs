...
namespace MailOdds.Test.Api
{
    ...
    public sealed class TemplateVersionsApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test CanaryTemplateVersion
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CanaryTemplateVersionAsyncTest()
        {
            string campaignId = default!;
            string versionId = default!;
            await _instance.CanaryTemplateVersionAsync(campaignId, versionId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateTemplateVersionAsyncTest()
        {
            string campaignId = default!;
            await _instance.CreateTemplateVersionAsync(campaignId);
        }
        ...
        public async Task GetTemplateVersionAsyncTest()
        {
            string campaignId = default!;
            string versionId = default!;
            await _instance.GetTemplateVersionAsync(campaignId, versionId);
        }
        ...
        {
            string campaignId = default!;
            await _instance.ListTemplateVersionsAsync(campaignId);
        }
        ...
        public async Task PromoteTemplateVersionAsyncTest()
        {
            string campaignId = default!;
            string versionId = default!;
            await _instance.PromoteTemplateVersionAsync(campaignId, versionId);
        }

        /// <summary>
        /// Test RollbackTemplateVersion
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RollbackTemplateVersionAsyncTest()
        {
            string campaignId = default!;
            await _instance.RollbackTemplateVersionAsync(campaignId);
        }

        /// <summary>
        /// Test UpdateTemplateVersion
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateTemplateVersionAsyncTest()
        {
            string campaignId = default!;
            string versionId = default!;
            await _instance.UpdateTemplateVersionAsync(campaignId, versionId);
        }
    }
}
