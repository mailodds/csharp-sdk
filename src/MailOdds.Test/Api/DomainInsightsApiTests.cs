...
{
    /// <summary>
    ///  Class for testing DomainInsightsApi
    /// </summary>
    public sealed class DomainInsightsApiTests : ApiTestsBase
    {
        private readonly IDomainInsightsApi _instance;

        public DomainInsightsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IDomainInsightsApi>();
        }

        /// <summary>
        /// Test GetDomainHookEffectiveness
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDomainHookEffectivenessAsyncTest()
        {
            string domainId = default!;
            Client.Option<int> days = default!;
            var response = await _instance.GetDomainHookEffectivenessAsync(domainId, days);
            var model = response.Ok();
            Assert.IsType<GetDomainHookEffectiveness200Response>(model);
        }

        /// <summary>
        /// Test GetDomainInsightsFunnel
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDomainInsightsFunnelAsyncTest()
        {
            string domainId = default!;
            Client.Option<int> days = default!;
            var response = await _instance.GetDomainInsightsFunnelAsync(domainId, days);
            var model = response.Ok();
            Assert.IsType<GetDomainInsightsFunnel200Response>(model);
        }

        /// <summary>
        /// Test GetDomainInsightsTrends
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDomainInsightsTrendsAsyncTest()
        {
            string domainId = default!;
            Client.Option<int> days = default!;
            var response = await _instance.GetDomainInsightsTrendsAsync(domainId, days);
            var model = response.Ok();
            Assert.IsType<GetDomainInsightsTrends200Response>(model);
        }
    }
}
