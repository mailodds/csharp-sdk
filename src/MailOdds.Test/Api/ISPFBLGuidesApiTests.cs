...
{
    /// <summary>
    ///  Class for testing ISPFBLGuidesApi
    /// </summary>
    public sealed class ISPFBLGuidesApiTests : ApiTestsBase
    {
        private readonly IISPFBLGuidesApi _instance;

        public ISPFBLGuidesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IISPFBLGuidesApi>();
        }
        ...
        public async Task GetIspFblGuideAsyncTest()
        {
            string ispId = default!;
            await _instance.GetIspFblGuideAsync(ispId);
        }

        /// <summary>
        /// Test ListIspFblGuides
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListIspFblGuidesAsyncTest()
        {
            await _instance.ListIspFblGuidesAsync();
        }
    }
}
