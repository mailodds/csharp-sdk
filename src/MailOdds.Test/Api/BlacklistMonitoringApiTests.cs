...
{
    /// <summary>
    ///  Class for testing BlacklistMonitoringApi
    /// </summary>
    public sealed class BlacklistMonitoringApiTests : ApiTestsBase
    {
        private readonly IBlacklistMonitoringApi _instance;

        public BlacklistMonitoringApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IBlacklistMonitoringApi>();
        }

        /// <summary>
        /// Test AddBlacklistMonitor
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddBlacklistMonitorAsyncTest()
        {
            AddBlacklistMonitorRequest addBlacklistMonitorRequest = default!;
            var response = await _instance.AddBlacklistMonitorAsync(addBlacklistMonitorRequest);
            var model = response.Created();
            Assert.IsType<AddBlacklistMonitor201Response>(model);
        }

        /// <summary>
        /// Test GetBlacklistHistory
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetBlacklistHistoryAsyncTest()
        {
            string monitorId = default!;
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            var response = await _instance.GetBlacklistHistoryAsync(monitorId, page, perPage);
            var model = response.Ok();
            Assert.IsType<GetBlacklistHistory200Response>(model);
        }

        /// <summary>
        /// Test ListBlacklistMonitors
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListBlacklistMonitorsAsyncTest()
        {
            var response = await _instance.ListBlacklistMonitorsAsync();
            var model = response.Ok();
            Assert.IsType<ListBlacklistMonitors200Response>(model);
        }

        /// <summary>
        /// Test RunBlacklistCheck
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RunBlacklistCheckAsyncTest()
        {
            string monitorId = default!;
            var response = await _instance.RunBlacklistCheckAsync(monitorId);
            var model = response.Ok();
            Assert.IsType<RunBlacklistCheck200Response>(model);
        }
    }
}
