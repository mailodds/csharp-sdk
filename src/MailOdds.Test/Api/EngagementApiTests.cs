...
{
    /// <summary>
    ///  Class for testing EngagementApi
    /// </summary>
    public sealed class EngagementApiTests : ApiTestsBase
    {
        private readonly IEngagementApi _instance;

        public EngagementApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IEngagementApi>();
        }

        /// <summary>
        /// Test GetDisengagedContacts
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDisengagedContactsAsyncTest()
        {
            Client.Option<int> inactiveDays = default!;
            Client.Option<int> minSends = default!;
            Client.Option<string> domainId = default!;
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            var response = await _instance.GetDisengagedContactsAsync(inactiveDays, minSends, domainId, page, perPage);
            var model = response.Ok();
            Assert.IsType<GetDisengagedContacts200Response>(model);
        }

        /// <summary>
        /// Test GetEngagementScore
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetEngagementScoreAsyncTest()
        {
            string email = default!;
            var response = await _instance.GetEngagementScoreAsync(email);
            var model = response.Ok();
            Assert.IsType<GetEngagementScore200Response>(model);
        }

        /// <summary>
        /// Test GetEngagementSummary
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetEngagementSummaryAsyncTest()
        {
            Client.Option<string> domainId = default!;
            var response = await _instance.GetEngagementSummaryAsync(domainId);
            var model = response.Ok();
            Assert.IsType<GetBounceStatsSummary200Response>(model);
        }

        /// <summary>
        /// Test SuppressDisengaged
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SuppressDisengagedAsyncTest()
        {
            SuppressDisengagedRequest suppressDisengagedRequest = default!;
            var response = await _instance.SuppressDisengagedAsync(suppressDisengagedRequest);
            var model = response.Ok();
            Assert.IsType<SuppressDisengaged200Response>(model);
        }
    }
}
