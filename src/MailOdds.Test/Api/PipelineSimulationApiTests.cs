...
{
    /// <summary>
    ///  Class for testing PipelineSimulationApi
    /// </summary>
    public sealed class PipelineSimulationApiTests : ApiTestsBase
    {
        private readonly IPipelineSimulationApi _instance;

        public PipelineSimulationApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IPipelineSimulationApi>();
        }

        /// <summary>
        /// Test SimulatePipeline
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SimulatePipelineAsyncTest()
        {
            await _instance.SimulatePipelineAsync();
        }
    }
}
