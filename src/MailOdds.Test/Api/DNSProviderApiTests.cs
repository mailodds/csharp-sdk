...
{
    /// <summary>
    ///  Class for testing DNSProviderApi
    /// </summary>
    public sealed class DNSProviderApiTests : ApiTestsBase
    {
        private readonly IDNSProviderApi _instance;

        public DNSProviderApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IDNSProviderApi>();
        }

        /// <summary>
        /// Test ConnectDnsProvider
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ConnectDnsProviderAsyncTest()
        {
            ConnectDnsProviderRequest connectDnsProviderRequest = default!;
            await _instance.ConnectDnsProviderAsync(connectDnsProviderRequest);
        }

        /// <summary>
        /// Test DisconnectDnsProvider
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DisconnectDnsProviderAsyncTest()
        {
            await _instance.DisconnectDnsProviderAsync();
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDnsProviderAsyncTest()
        {
            await _instance.GetDnsProviderAsync();
        }
    }
}
