...
{
    /// <summary>
    ///  Class for testing InboundRulesApi
    /// </summary>
    public sealed class InboundRulesApiTests : ApiTestsBase
    {
        private readonly IInboundRulesApi _instance;

        public InboundRulesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IInboundRulesApi>();
        }

        /// <summary>
        /// Test CreateInboundRule
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateInboundRuleAsyncTest()
        {
            string domainId = default!;
            await _instance.CreateInboundRuleAsync(domainId);
        }

        /// <summary>
        /// Test DeleteInboundRule
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteInboundRuleAsyncTest()
        {
            string domainId = default!;
            string ruleId = default!;
            await _instance.DeleteInboundRuleAsync(domainId, ruleId);
        }

        /// <summary>
        /// Test DryRunInboundRules
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DryRunInboundRulesAsyncTest()
        {
            string domainId = default!;
            await _instance.DryRunInboundRulesAsync(domainId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetInboundRuleAsyncTest()
        {
            string domainId = default!;
            string ruleId = default!;
            await _instance.GetInboundRuleAsync(domainId, ruleId);
        }

        /// <summary>
        /// Test ListInboundRules
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListInboundRulesAsyncTest()
        {
            string domainId = default!;
            await _instance.ListInboundRulesAsync(domainId);
        }

        /// <summary>
        /// Test UpdateInboundRule
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateInboundRuleAsyncTest()
        {
            string domainId = default!;
            string ruleId = default!;
            await _instance.UpdateInboundRuleAsync(domainId, ruleId);
        }
    }
}
