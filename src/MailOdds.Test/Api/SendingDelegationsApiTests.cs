...
{
    /// <summary>
    ///  Class for testing SendingDelegationsApi
    /// </summary>
    public sealed class SendingDelegationsApiTests : ApiTestsBase
    {
        private readonly ISendingDelegationsApi _instance;

        public SendingDelegationsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISendingDelegationsApi>();
        }
        ...
        public async Task CreateDelegationAsyncTest()
        {
            string domainId = default!;
            await _instance.CreateDelegationAsync(domainId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListDelegationsAsyncTest()
        {
            string domainId = default!;
            await _instance.ListDelegationsAsync(domainId);
        }

        /// <summary>
        /// Test RevokeDelegation
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RevokeDelegationAsyncTest()
        {
            string domainId = default!;
            string delegationId = default!;
            await _instance.RevokeDelegationAsync(domainId, delegationId);
        }
    }
}
