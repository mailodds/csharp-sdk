...
{
    /// <summary>
    ///  Class for testing SenderHealthApi
    /// </summary>
    public sealed class SenderHealthApiTests : ApiTestsBase
    {
        private readonly ISenderHealthApi _instance;

        public SenderHealthApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISenderHealthApi>();
        }

        /// <summary>
        /// Test GetSenderHealth
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSenderHealthAsyncTest()
        {
            Client.Option<string> period = default!;
            var response = await _instance.GetSenderHealthAsync(period);
            var model = response.Ok();
            Assert.IsType<GetSenderHealth200Response>(model);
        }

        /// <summary>
        /// Test GetSenderHealthTrend
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSenderHealthTrendAsyncTest()
        {
            Client.Option<string> period = default!;
            var response = await _instance.GetSenderHealthTrendAsync(period);
            var model = response.Ok();
            Assert.IsType<GetSenderHealthTrend200Response>(model);
        }
    }
}
