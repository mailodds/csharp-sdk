...
namespace MailOdds.Test.Model
{
    ...
    public class CreateStoreRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" CreateStoreRequest
            //Assert.IsType<CreateStoreRequest>(instance);
        }
