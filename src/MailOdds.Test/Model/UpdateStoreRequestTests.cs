...
namespace MailOdds.Test.Model
{
    ...
    public class UpdateStoreRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" UpdateStoreRequest
            //Assert.IsType<UpdateStoreRequest>(instance);
        }
